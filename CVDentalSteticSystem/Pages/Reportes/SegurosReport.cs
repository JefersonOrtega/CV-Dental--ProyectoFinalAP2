...
namespace CVDentalSteticSystem.Pages.Reportes
{
    public class SegurosReport
    {
        ...
        public byte[] Reporte(List<Seguros> seguros)
        {
        ...
        private PdfPTable setPageTitle()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Reporte de Seguros", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.Colspan = 2;
            pdfCell.Border = 0;
            pdfCell.ExtraParagraphSpace = 0;
        ...
        private void ReportBody()
        {
            ...
            foreach (var item in listaSeguros)
            {
                num++;
                pdfCell = new PdfPCell(new Phrase(item.SeguroId.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
